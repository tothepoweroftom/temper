...
public:
    ...
    virtual void buildUserInterface(UI* ui_interface) {
        ...
        ui_interface->declare(&fHslider7, "tooltip", "percentage of the feedback level in the delay loop");
        ui_interface->addHorizontalSlider("feedback", &fHslider7, 50.0f, 1.0f, 100.0f, 1.0f);
        ...
        ui_interface->addHorizontalSlider("glitch", &fHslider4, 0.0f, 0.0f, 2.0f, 0.01f);
        ui_interface->declare(&fHslider6, "name", "highpass (hz)");
        ui_interface->declare(&fHslider6, "tooltip", "highpass filter frequency in the feddback loop");
        ui_interface->addHorizontalSlider("highpass", &fHslider6, 120.0f, 20.0f, 20000.0f, 1.0f);
    ...
    virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
        ...
        float fSlow9 = std::tan((fConst4 * float(fHslider6)));
        ...
        float fSlow14 = (0.00999999978f * float(fHslider7));
        ...
        for (int i = 0; (i < count); i = (i + 1)) {
            ...
            float fTemp2 = std::min<float>(524288.0f, (fConst0 * (fSlow4 + ((2.0f * (1.0f - std::fabs(((2.0f * fRec5[0]) + -1.0f)))) + -1.0f))));
            ...
            float fTemp10 = ((iSlow2?fRec0[1]:(fRec7 + fRec6[1])) + (fSlow20 * fTemp0));
